export default function Character(name, type) {
  const errorName = new Error('Имя должно содержать не менее 2 символов и не более 10!');
  const errorType = new Error('Такого типа не существует!');
  const characterBase = {
